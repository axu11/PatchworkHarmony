...
var TestingRealm = function(game) {};
TestingRealm.prototype = {
	...
	create: function() {
		...
		this.droppedPlatform = platforms.create(200, 100, 'atlas', 'sky'); 
		this.droppedPlatform.scale.setTo(2.0, 0.25);
	...
	update: function(){
		...
		this.droppedPlatform.y += 5;
		if(this.droppedPlatform.y > 700){
			this.droppedPlatform.y = 100;
		}
